...
1010 LOCATE 0,0:PRINT "PLAY3 »ÝÌßÙÐ­°¼Þ¯¸":PRINT "COMPOSED BY KAZUMI MATSUNOKI":PRINT "(C) 1993.9.12"
1020 PLAY "T80O1:O1"
1030 *A:PRINT "*A ";
...
1270 PLAY "L1RGGRGRGRGRFFF#AR#A:L1CL3#DL1CL3#DL1CL3<#AL1GL3#AL1GG#A>D"
1280 GOTO *A